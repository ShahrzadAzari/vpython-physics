...
scene.center = vector(0.7, 1, 0) 

# Define scene objects (units are in meters)

# 1.4-m long inclined plane whose center is at 0.7 m
inclinedPlane = box(pos = vector(0.7, 0, 0), size = vector(1.4, 0.02, 0.2), color = color.green, opacity = 0.3)
...
# coefficient of friction between cart and plane
mu = 0.20 
