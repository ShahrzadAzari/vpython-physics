...
scene.center = vector(5, 1, 0) 

# Define scene objects (units are in meters)

# 10-m long inclined plane whose center is at 5 m
inclinedPlane = box(pos = vector(5, 0, 0), size = vector(10, 0.02, 0.2), color = color.green, opacity = 0.3)
...
motionMap = MotionMap(cart, 3, 10, markerType = "breadcrumbs", dropTime = False)

# Set timer in top right of screen
# timer position (units are in meters)
timerDisplay = PhysTimer(9, 5) 
